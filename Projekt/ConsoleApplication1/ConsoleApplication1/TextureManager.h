 ...
 * \brief  Class that manages all loaded textures from files.
 * 
 * \author https://github.com/netpoetica
 * \date   August 2023
 *********************************************************************/
...
public:
    ...
    /** Loads the texture and returns a pointer to it. If it is already loaded, this function just returns it. If it cannot find the file, returns NULL */
